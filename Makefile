# This Makefile is for the Finance::NASDAQ::Markets extension to perl.
#
...
NAME_SYM = Finance_NASDAQ_Markets
VERSION = 0.01
...
MAKE = make
FULLEXT = Finance/NASDAQ/Markets
BASEEXT = Markets
PARENT_NAME = Finance::NASDAQ
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Finance/NASDAQ/Markets.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Finance/NASDAQ/Markets.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Finance/NASDAQ
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Finance/NASDAQ
...
TO_INST_PM = lib/Finance/NASDAQ/Markets.pm

PM_TO_BLIB = lib/Finance/NASDAQ/Markets.pm \
...
DISTVNAME = Finance-NASDAQ-Markets-0.01
...
manifypods : pure_all  \
	lib/Finance/NASDAQ/Markets.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Finance/NASDAQ/Markets.pm $(INST_MAN3DIR)/Finance::NASDAQ::Markets.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Finance/NASDAQ/Markets.pm blib/lib/Finance/NASDAQ/Markets.pm 
